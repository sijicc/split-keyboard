...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT(
		...
		KC_CLCK, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOTE, KC_ENT,
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLASH, KC_RSFT,
		KC_LCTL, KC_LGUI, KC_LOPT, KC_SPC, KC_SPC, KC_ROPT, KC_RGUI, MO(1), KC_RCTL
		),
		
	[_FN] = LAYOUT(
		KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_DEL,
		_______, _______, KC_UP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCREEN,
